                ...
                <?php $__currentLoopData = $products->results(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-4 mb-5">
                        ...
                        <div class="d-flex">
                            ...
                            <a class="col-6 text-end align-self-center" href="<?php echo e(content_link($product->id)); ?>"> View</a>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\Logistic\src\MicroweberPackages\Shop\resources\views\/index.blade.php ENDPATH**/ ?>