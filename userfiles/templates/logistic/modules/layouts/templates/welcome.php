    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="outer">
                    <div class="inner">
                        <div class="about-txt about-bg-3 welcome-line edit safe-mode" rel="welcome_content" field="welcome_content">
            ...
            <div class="col-xl-6 col-lg-6 image-welcome edit" rel="welcome_image" field="welcome_image">
                <img src="<?php print template_url(); ?>assets/img/hero_bg.jpg" width="100%" alt="" />
            </div>
        </div>
    </div>
</div>
